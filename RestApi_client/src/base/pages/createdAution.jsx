...
const CreateAuction = () => {
  ...
  return (
    <div className="createdAuction">
      <Helmet>
        <title>Create Auction-Bid&Won</title>
      </Helmet>
            ...
            <div className="w-full md:w-1/2 h-100 px-4">
              <div className="bg-white rounded-lg shadow-lg p-4">
                ...
                <div className="mb-4 relative">
                  <label htmlFor="title" className="block absolute mb-1">
                    Title
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-4 relative">
                  <label htmlFor="description" className="block absolute mb-1">
                    Description
                  </label>
                  <textarea
                    id="description"
                ...
                <div className="mb-4 relative">
                  <label htmlFor="imageUrl" className="block absolute mb-1">
                    Image URL
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-4 relative">
                  <label htmlFor="endDate" className="block absolute mb-1">
                    End Date
                  </label>
                  <input
                    type="datetime-local"
